            ...
            <div className="leadcontent">
                ...
                <div className="leadmain">
                    ...
                    <div className="leadmaincontent">
                        <div className="leadcontentsub">
                            <div className="leadimage">
                                <img src="https://media.istockphoto.com/id/1317804578/photo/one-businesswoman-headshot-smiling-at-the-camera.jpg?s=612x612&w=0&k=20&c=EqR2Lffp4tkIYzpqYh8aYIPRr-gmZliRHRxcQC5yylY=" alt="" />
                                <label htmlFor="">
                                    <h5>Krish Watson</h5>
                                    <p>krishnayar@gmail.com</p>
                                </label>
                            </div>
                            <p id='leadtext'>USGC Logistics</p>
                            <p id='media'>392</p>
                            <p id='media'>2 Dec,2023</p>
                        ...
                        <div className="leadcontentsub">
                            <div className="leadimage">
                                <img src="https://media.istockphoto.com/id/1311084168/photo/overjoyed-pretty-asian-woman-look-at-camera-with-sincere-laughter.webp?b=1&s=170667a&w=0&k=20&c=XPuGhP9YyCWquTGT-tUFk6TwI-HZfOr1jNkehKQ17g0=" alt="" />
                                <label htmlFor="">
                                    <h5>Wrade Warnan</h5>
                                    <p>sanjaynayar@gmail.com</p>
                                </label>
                            </div>
                            <p id='leadtext'>NorthBound Logistics</p>
                            <p id='media'>192</p>
                            <p id='media'>2 Dec,2023</p>
                            <div className="leadlogo">
                                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg>
                        ...
                        <div className="leadcontentsub">
                        ...
                        </div>               <div className="leadcontentsub">
                            <div className="leadimage">
                                <img src="https://media.istockphoto.com/id/1317804578/photo/one-businesswoman-headshot-smiling-at-the-camera.jpg?s=612x612&w=0&k=20&c=EqR2Lffp4tkIYzpqYh8aYIPRr-gmZliRHRxcQC5yylY=" alt="" />
                                <label htmlFor="">
                                    <h5>Krish Watson</h5>
                            ...
                            <p id='leadtext'>Bend Logistics</p>
                            <p id='media'>392</p>
                            <p id='media'>2 Dec,2023</p>
                            <div className="leadlogo">
                                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg>
                            ...
                            <p id='leadtext'>SFO Group System</p>
                            <p id='media'>392</p>
                            <p id='media'>2 Dec,2023</p>
                            <div className="leadlogo">
                                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 512 512"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg>
